/* 
* SLAVE CONTROLLER #2, ADDRESS 0x0B
*/
#include <Wire.h>
...
//devices list
String devices[10] = {
  "BEDROOM_1 LPWM",      // D10, ATMEGA328P pin 16
  "BATHROOM_1 LPWM",     // D9, ATMEGA328P pin 15
  "SENSOR_1 TSENS",      // A0, ATMEGA328P pin 23
  "EMPTY",
  "EMPTY",
  "EMPTY",
  "EMPTY",
...
void receiveEvent(int bytes)
{
 ...
 //read from I2C
  ...
  else if(prefix.equals("SET")) //if it's a SET we need to set an actuator
  {
    ...
    //handle actuators
    if(object.equals("BEDROOM_1")) 
    { 
     analogWrite(bedroom_1_pin, value);
     if(debug)
     { 
      Serial.print("bedroom_1_pin : ");
      Serial.print(value,DEC);
      Serial.print("\n");
     } 
    }
        if(object.equals("BATHROOM_1")) 
    { 
     analogWrite(bathroom_1_pin, value);
     if(debug)
     { 
      Serial.print("bathroom_1_pin : ");
      Serial.print(value,DEC);
      Serial.print("\n");
     } 
    }
